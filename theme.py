...
_CSS_RULES = [
    ...
    _ROOT_CSS.replace("\n", " "),
    "html, body, .stApp, [data-testid=\"stAppViewContainer\"], [data-testid=\"stMain\"], [data-testid=\"stMainBlockContainer\"], .main .block-container, [data-testid=\"stSidebar\"], [data-testid=\"stSidebarContent\"], [data-testid=\"stBottomBlockContainer\"], [data-testid=\"stHeader\"] { background: var(--bg) !important; color: var(--text) !important; font-family: 'IBM Plex Sans', sans-serif !important; }",
    ".stApp p, .stApp li, .stApp label { font-family: 'IBM Plex Sans', sans-serif !important; color: var(--text) !important; }",
    "[data-baseweb=\"tooltip\"], [data-baseweb=\"tooltip\"] *, [class*=\"TooltipContent\"], [class*=\"TooltipContent\"] * { font-family: 'IBM Plex Sans', sans-serif !important; color: var(--text) !important; background-color: var(--surface) !important; }",
    ...
    "[data-testid=\"stFileUploader\"] *, [data-testid=\"stFileUploader\"] *::before, [data-testid=\"stFileUploader\"] *::after { background-color: var(--surface) !important; background-image: none !important; color: var(--text) !important; }",
    ...
    ".stApp h1, .stApp h2, .stApp h3 { font-family: 'Archivo Narrow', sans-serif !important; text-transform: uppercase; letter-spacing: 0.04em; font-weight: 700; color: var(--ink) !important; }",
    ".stApp h2 { border-bottom: 1px solid var(--border); padding-bottom: 0.3em; margin-top: 1.6em; }",
    "[data-testid=\"stMetric\"] { background: var(--surface) !important; border: 1px solid var(--border); border-radius: 6px; padding: 0.8rem 1rem; }",
    "[data-testid=\"stMetricLabel\"] { font-family: 'Archivo Narrow', sans-serif !important; text-transform: uppercase; letter-spacing: 0.04em; font-size: 0.78rem; color: var(--muted) !important; }",
    "[data-testid=\"stMetricValue\"] { font-family: 'IBM Plex Mono', monospace !important; color: var(--text) !important; }",
    "[data-testid=\"stExpander\"] { background: var(--surface) !important; border: 1px solid var(--border); border-radius: 6px; }",
    "[data-testid=\"stExpander\"] summary, [data-testid=\"stExpander\"] summary p { color: var(--text) !important; }",
    "[data-testid=\"stExpander\"] summary:hover, [data-testid=\"stExpander\"] summary:focus { background: var(--surface) !important; color: var(--discipline) !important; }",
    "[data-testid=\"stExpanderDetails\"] { background: var(--surface) !important; color: var(--text) !important; }",
    "::selection { background: var(--discipline) !important; color: var(--bg) !important; }",
    "[data-testid=\"stDataFrameResizable\"] { color: var(--text) !important; }",
    ".stButton>button { font-family: 'Archivo Narrow', sans-serif !important; text-transform: uppercase; letter-spacing: 0.06em; border: 2px solid var(--loss); background: transparent !important; color: var(--loss) !important; border-radius: 4px; }",
    ".stButton>button:hover { background: var(--loss) !important; color: var(--bg) !important; border-color: var(--loss); }",
    "[data-testid=\"stDataFrame\"] { font-family: 'IBM Plex Mono', monospace !important; color: var(--text) !important; }",
